...
```bash
# 在项目根目录运行
cd /Users/guide/Desktop/interview-rag-system
...
```bash
# 运行单元测试
./gradlew test --tests "interview.rag.system.infrastructure.file.DocumentParseServiceTest"

# 运行集成测试
./gradlew test --tests "interview.rag.system.infrastructure.file.DocumentParseIntegrationTest"
```
