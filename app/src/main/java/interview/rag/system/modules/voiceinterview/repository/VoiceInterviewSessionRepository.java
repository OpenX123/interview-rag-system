package interview.rag.system.modules.voiceinterview.repository;

import interview.rag.system.modules.voiceinterview.model.VoiceInterviewSessionEntity;
import interview.rag.system.modules.voiceinterview.model.VoiceInterviewSessionEntity.InterviewPhase;
...
public interface VoiceInterviewSessionRepository extends JpaRepository<VoiceInterviewSessionEntity, Long> {
    ...
    Optional<VoiceInterviewSessionEntity> findByStatusAndEndTimeBefore(
        interview.rag.system.common.model.AsyncTaskStatus status,
        LocalDateTime time
    );
    ...
    List<VoiceInterviewSessionEntity> findByEvaluateStatusAndUpdatedAtBefore(
        interview.rag.system.common.model.AsyncTaskStatus evaluateStatus,
        LocalDateTime time
    );
}
