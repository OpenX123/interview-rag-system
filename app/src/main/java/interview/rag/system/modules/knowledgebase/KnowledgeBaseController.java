package interview.rag.system.modules.knowledgebase;

import interview.rag.system.common.annotation.RateLimit;
import interview.rag.system.common.result.Result;
import interview.rag.system.modules.knowledgebase.model.KnowledgeBaseChunkDTO;
import interview.rag.system.modules.knowledgebase.model.KnowledgeBaseListItemDTO;
import interview.rag.system.modules.knowledgebase.model.KnowledgeBaseStatsDTO;
import interview.rag.system.modules.knowledgebase.model.QueryRequest;
import interview.rag.system.modules.knowledgebase.model.QueryResponse;
import interview.rag.system.modules.knowledgebase.model.VectorStatus;
import interview.rag.system.modules.knowledgebase.service.KnowledgeBaseDeleteService;
import interview.rag.system.modules.knowledgebase.service.KnowledgeBaseListService;
import interview.rag.system.modules.knowledgebase.service.KnowledgeBaseQueryService;
import interview.rag.system.modules.knowledgebase.service.KnowledgeBaseUploadService;
...
public class KnowledgeBaseController {
    ...
    /**
     * 获取指定知识库的所有向量切片（chunks）。
     * 用于在管理页查看 embedding 实际切分结果，验证 RAG 数据质量。
     */
    @GetMapping("/api/knowledgebase/{id}/chunks")
    public Result<List<KnowledgeBaseChunkDTO>> getKnowledgeBaseChunks(@PathVariable Long id) {
        return Result.success(listService.listChunks(id));
    }
