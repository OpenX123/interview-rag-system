...
function ScoreCard({
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-700 rounded-xl p-8">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="relative w-32 h-32 mb-6">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <motion.span
              className="text-4xl font-semibold text-stone-900 dark:text-stone-100 tabular-nums"
            ...
            <span className="text-xs text-stone-500 dark:text-stone-400 tracking-wide mt-0.5">总分</span>
          </div>
        </div>

        <h3 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mb-3">面试评估</h3>
        <p className="text-sm text-stone-700 dark:text-stone-300 max-w-2xl leading-relaxed">
